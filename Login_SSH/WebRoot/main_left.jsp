...
<body style="background:#f0f9fd;">
    ...
    <s:if test="#session.post_id3=='post_03'">
    <dd>
    <div class="title">
    <a href="<%=basePath%>/Tax_chiefOperate.action?user_num=<s:property value="#session.user_num"/>&post_id=<s:property value="#session.post_id3"/>" target="rightFrame"><span><img src="images/leftico02.png" /></span>股长操作</a>
    </div>    
    </dd> 
     </s:if>
    <s:if test="#session.post_id4=='post_04'">
    <dd>
    <div class="title">
    <a href="<%=basePath%>/Tax_collectiveOperate.action?user_num=<s:property value="#session.user_num"/>&post_id=<s:property value="#session.post_id4"/>" target="rightFrame"><span><img src="images/leftico02.png" /></span>局党组操作</a>
    </div>    
    </dd> 
     </s:if>
